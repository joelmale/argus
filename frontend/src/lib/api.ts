...
export const assetsApi = {
  ...
  exportCsv: () => api.get("/api/v1/assets/export.csv"),
  exportAnsible: () => api.get("/api/v1/assets/export.ansible.ini"),
  exportTerraform: () => api.get("/api/v1/assets/export.terraform.tf.json"),
  exportInventoryJson: () => api.get("/api/v1/assets/export.inventory.json"),
  exportJsonReport: () => api.get("/api/v1/assets/report.json"),
  exportHtmlReport: () => api.get("/api/v1/assets/report.html"),
  downloadExportJob: (jobId: string) => api.get(`/api/v1/assets/export-jobs/${jobId}/download`, { responseType: "blob" }),
